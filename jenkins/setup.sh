...
echo "TODO: Set up the jenkins-bot security token: log into jenkins as"
echo "      the jenkins@khanacademy.org user (password in secrets.py), and"
echo "      then visit http://jenkins.khanacademy.org/me/configure"
echo "      and click on 'show API token...', and copy that value into"
echo "      ${JENKINS_HOME}/jenkins_token"
